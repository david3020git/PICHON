...
{  ?>
        ...
        <input type="hidden" name="datosUsuario" value="<?php echo implode(";",$datosUsuario) ?>">
...
<?php } else{ ?>
 ...
 <!--/* $_int = mostrarArray(explode(":", $datosUsuario["intereses"] ));
    print <<< HTML
Usuario: {$datosUsuario["usuario"]}<br/>    
Pass: {$datosUsuario["pass"]}<br/>
edad: {$datosUsuario["edad"]}<br/>
Sexo: {$datosUsuario["sexo"]}<br/>
Intereses: <ul>$_int</ul>
HTML;/*
-->
